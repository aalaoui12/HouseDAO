...
const App = () => {
  ...
  const token = useToken("0xcBE080DD429EE18965Cc63b892Bc0FC5DAbbd44B");
  const vote = useVote("0xD95B45fCFE75D9E440b3A0d9033353B75a287428");
...
// Retrieve all our existing proposals from the contract (when vote contract changes from previous render)
useEffect(() => {
  if (!hasClaimedNFT) {
    return;
  }
...
// effect to check if user has voted on the first proposal or not yet.
useEffect(() => {
  if (!hasClaimedNFT) {
    return;
  }
